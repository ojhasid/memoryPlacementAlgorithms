...
* Author: Sujeet Ojha
* Procedures:
* main  - this function calls the firstFit, nextFit, worstFit, and bestFit
		  function and displays the results regarding the time consumed
		  
* firstFit - this function takes in a thousand task streams and performs the
			 first fit algorithm to place them in memory
			 
* nextFit -  this function takes in a thousand task streams and performs the
			 next fit algorithm to place them in memory
			 
* bestFit -  this function takes in a thousand task streams and performs the
			 best fit algorithm to place them in memory
			 
* worstFit - this function takes in a thousand task streams and performs the
			 worst fit algorithm to place them in memory
...
* print - this function displays the process number, the task size, the block
		  occupied by the process, and the process duration
***************************************************************************/
...
/***************************************************************************
* void firstFit( int blockSize[], int m, struct taskStream process[], int n )
* Author: Sujeet Ojha
* Date: 7 April 2020
* Description: processes the taskStream using the firstFit algorithm and stores
			   them into memory.
			   Increments/decrements the process duration and time consumed as required.
*
* Parameters:
* blockSize[] I/P int - Array representing the memory blocks
* process[] I/P struct taskStream - The array of processes filled with random values
* n I/P int - The amount of tasks in the stream
...
/***************************************************************************
* void bestFit( int blockSize[], int m, struct taskStream process[], int n )
* Author: Sujeet Ojha
* Date: 7 April 2020
* Description: processes the taskStream using the bestFit algorithm and stores
			   them into memory.
			   Increments/decrements the process duration and time consumed as required.
*
* Parameters:
...
/***************************************************************************
* void nextFit( int blockSize[], int m, struct taskStream process[], int n )
* Author: Sujeet Ojha
* Date: 7 April 2020
* Description: processes the taskStream using the nextFit algorithm and stores
			   them into memory.
			   Increments/decrements the process duration and time consumed as required.
*
* Parameters:
...
/***************************************************************************
* void worstFit( int blockSize[], int m, struct taskStream process[], int n )
* Author: Sujeet Ojha
* Date: 7 April 2020
* Description: processes the taskStream using the worstFit algorithm and stores
			   them into memory.
			   Increments/decrements the process duration and time consumed as required.
*
* Parameters:
...
/***************************************************************************
* void randomize( struct taskStream arrayTasks[], int blockSize[], int numTasks )
* Author: Sujeet Ojha
* Date: 7 April 2020
...
* Description: Initializes the task stream by calling the randomize() function
			   and calls the rest of the memory placement algorithms in order
			   to generate results regarding the time consumed.
			   The time consumed results are displayed at the end. 
* Parameters:
...
{ 
	...
	struct taskStream arrayTasks[numTasks];    														//Structure array of 1000 tasks
